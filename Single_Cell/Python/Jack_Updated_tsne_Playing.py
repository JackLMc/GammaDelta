...
os.chdir("/Users/jlm650/OneDrive/UoB/PhD/1st_Year/Projects/4_Gamma_Delta")
pwd()
tsne = pd.read_csv("/Users/jlm650/OneDrive/UoB/PhD/1st_Year/Projects/4_Gamma_Delta/Single_Cell/Data/tSNE_coords.txt",sep=" ")
...
tpms = pd.read_csv("/Users/jlm650/OneDrive/UoB/PhD/1st_Year/Projects/4_Gamma_Delta/Single_Cell/Data/log_tpms_with_gene_names.txt", sep=" ")
...
name_map = pd.read_csv("/Users/jlm650/OneDrive/UoB/PhD/1st_Year/Projects/4_Gamma_Delta/Single_Cell/Data/name_map.txt",sep="\t", index_col=0)

name_map.index = ["_".join(x.split("_")[0:2]) + "#" + x.split("_")[2] for x in name_map.index]

name_map.head()

#This doesn't seem to work... 
tsne = pd.merge(tsne, name_map, left_index = True, right_index = True)

# In[15]:

name_map.reset_index(level=0, inplace=True)
name_map = name_map.rename(columns={'index': 'fastq_name'})
...
with open("/Users/jlm650/OneDrive/UoB/PhD/1st_Year/Projects/4_Gamma_Delta/Single_Cell/Data/clonotypes.txt") as f:
    for line in f:
        line = line.rstrip()
        line = line.split(",")
